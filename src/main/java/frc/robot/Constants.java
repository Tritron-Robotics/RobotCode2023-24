...
public class Constants {
    public static final class ModuleConstants{
        ...
        public static final double kWheelDiameters = Units.inchesToMeters(4);
        public static final double kDriveMotorGearRatio = 1 / 5.8486;
        public static final double kTurnMotorGearRatio = 1 / 18.0;
        public static final double kDriveEncoderRot2Meter = kDriveMotorGearRatio * Math.PI * kWheelDiameters; 
        public static final double kTurnEncoderRot2Meter = kTurnMotorGearRatio * 2 * Math.PI;
        public static final double kDriveEncoderRPM2MeterPerSec = kDriveEncoderRot2Meter / 60;
        public static final double kTurnEncoderRPM2MetersPerSec = kTurnEncoderRot2Meter / 60;
